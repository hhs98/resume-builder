...
export function WorkHistoryStep() {
  ...
  return (
    <BuilderStepPage>
      <BuilderStepToolbar backHref="/new" />

      <BuilderStepHeader
        title="Tell us about your work history"
        description="Add your recent jobs first and work backward."
      />
                ...
                <div className="space-y-4 pl-2">
                  ...
                  <div>
                    ...
                    <Textarea
                      ...
                      className={cn(builderTextareaClassName, "min-h-36")}
